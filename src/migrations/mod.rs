...
impl<DB: Database> MigrationManager<DB> {
    ...
    pub fn register_migration(
        ...
        self.migrations.insert(migration.id.clone(), (migration, postgres_sql, mysql_sql));
    }
    ...
    pub async fn run_migrations(&self) -> Result<()> {
        ...
        let mut pending_migrations: Vec<_> = self.migrations.values()
        ...
        for (migration, postgres_sql, mysql_sql) in pending_migrations {
            ...
            self.runner.record_migration(migration, execution_time_ms).await?;
            
            info!("Completed migration {} in {}ms", migration.id, execution_time_ms);
        }
    ...
    pub async fn get_migration_status(&self) -> Result<Vec<(Migration, bool)>> {
        ...
        let mut status: Vec<_> = self.migrations.values()
    ...
    fn register_builtin_migrations(&mut self) {
        ...
        self.register_migration(
            Migration {
                ...
                version: 2,
                created_at: chrono::DateTime::parse_from_rfc3339("2025-02-01T00:00:00Z").unwrap().with_timezone(&Utc),
            },
        ...
        self.register_migration(
            Migration {
                ...
                version: 3,
                created_at: chrono::DateTime::parse_from_rfc3339("2025-03-01T00:00:00Z").unwrap().with_timezone(&Utc),
            },
        ...
        self.register_migration(
            Migration {
                ...
                version: 4,
                created_at: chrono::DateTime::parse_from_rfc3339("2025-04-01T00:00:00Z").unwrap().with_timezone(&Utc),
            },
        ...
        self.register_migration(
            Migration {
                ...
                version: 5,
                created_at: chrono::DateTime::parse_from_rfc3339("2025-05-01T00:00:00Z").unwrap().with_timezone(&Utc),
            },
        ...
        self.register_migration(
            Migration {
                ...
                version: 6,
                created_at: chrono::DateTime::parse_from_rfc3339("2025-06-01T00:00:00Z").unwrap().with_timezone(&Utc),
            },
